...
class MultiHeadedAttention(nn.Module):
    ...
    def __init__(self, n_head, n_feat, dropout_rate):
        ...
        print("n_feat ss: " + str(n_feat))
        print("n_head ss: " + str(n_head))
        assert n_feat % n_head == 0
        # We assume d_v always equals d_k
        # print("n_feat: " + str(n_feat))
        # print("n_head: " + str(n_head))
        self.d_k = n_feat // n_head
        # print("d_k: " + str(self.d_k))
        self.h = n_head
...
class RelPositionMultiHeadedAttention(MultiHeadedAttention):
	...
	#size1 und size 2 einführen (Michael Tipps 23_03_23)
	#q,k,v = self.transform(auf basis von q,k,v input)
